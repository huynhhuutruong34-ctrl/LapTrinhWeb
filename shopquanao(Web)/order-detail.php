...
<section style="padding: 2rem 0;">
    <a href="/orders.php" style="color: #3498db; text-decoration: none; margin-bottom: 1rem; display: inline-block;">← Quay lại</a>
    ...
    <div style="max-width: 800px;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
            <div style="background: white; padding: 1.5rem; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                ...
                <p style="margin-bottom: 0.75rem;"><strong>Ngày đặt:</strong> <?php echo date('d/m/Y H:i', strtotime($order['created_at'])); ?></p>
                <p style="margin-bottom: 0.75rem;"><strong>Trạng thái:</strong>
                    <?php if ($order['status'] === 'confirmed'): ?>
                        <span style="background: #3498db; color: white; padding: 0.25rem 0.75rem; border-radius: 4px; font-size: 0.9rem;">Xác nhận</span>
                    <?php elseif ($order['status'] === 'shipped'): ?>
                        <span style="background: #f39c12; color: white; padding: 0.25rem 0.75rem; border-radius: 4px; font-size: 0.9rem;">Đang giao</span>
                    <?php elseif ($order['status'] === 'delivered'): ?>
                        <span style="background: #27ae60; color: white; padding: 0.25rem 0.75rem; border-radius: 4px; font-size: 0.9rem;">Đã giao</span>
                    <?php else: ?>
                        <span style="background: #95a5a6; color: white; padding: 0.25rem 0.75rem; border-radius: 4px; font-size: 0.9rem;">Chờ xử lý</span>
                    <?php endif; ?>
                </p>
            </div>
            ...
            <div style="background: white; padding: 1.5rem; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                ...
                <p style="white-space: pre-wrap; margin-bottom: 0.75rem;"><?php echo htmlspecialchars($order['shipping_address']); ?></p>
        ...
        <a href="/orders.php" style="display: inline-block; padding: 0.75rem 1.5rem; background: #95a5a6; color: white; text-decoration: none; border-radius: 4px;">
            ← Quay lại
        </a>
    </div>
</section>
