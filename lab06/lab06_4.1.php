...
$thong_tin  = postIndex("thong_tin"); // Lấy dữ liệu từ textarea thong_tin

// Xử lý chuỗi thong_tin
if ($thong_tin != "") {
    // Loại bỏ các thẻ HTML trong thong_tin
    $thong_tin = strip_tags($thong_tin);
    
    // Thay thế ký hiệu xuống hàng \n bằng thẻ <br> trong chuỗi
    $thong_tin = nl2br($thong_tin);
    
    // Thêm ký tự \ trước các ký tự nháy đơn
    $thong_tin = addslashes($thong_tin);

    // Loại bỏ các ký tự \ trước các ký tự đặc biệt
        ...
        <form action="lab06_1.php" method="post" enctype="multipart/form-data">
            <table align="center">
                ...
                <tr>
                    ...
                    <td><textarea name="thong_tin" rows="5" cols="50"><?php echo $thong_tin; ?></textarea></td>
                </tr>
                <tr>
        ...
        ?>
            <div class="info">
                ...
                if ($err != "") echo $err;
                    ...
                    // Mã hóa mật khẩu bằng SHA1 và MD5
                    ...
                    // In ra thong_tin sau khi xử lý
                    echo "Thông tin đã xử lý: <br>" . $thong_tin;
                }
                ?>
            </div>
        <?php
